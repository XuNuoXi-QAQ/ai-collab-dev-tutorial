  ...
  if (sourceMode === "folder" && sourcePath) {
    ...
    if (globalSearchPlugin == null ? void 0 : globalSearchPlugin.instance) {
      ...
      if (searchLeaf && searchLeaf.view && searchLeaf.view.dom) {
        ...
        if (resultDomLookup) {
          const files = Array.from(resultDomLookup.keys()).filter((file) => file instanceof import_obsidian2.TFile);
          return sortFiles(files, gridView);
        }
      }
    }
...
var GridView = class extends import_obsidian22.ItemView {
  // 指定下次渲染要對焦的檔案路徑
  constructor(leaf, plugin) {
    super(leaf);
    this.sourceMode = "";
  ...
  async render() {
    ...
    if (this.sourceMode === "folder" && this.sourcePath !== "/") {
      ...
      const noteFile = this.app.vault.getAbstractFileByPath(notePath);
      if (noteFile instanceof import_obsidian22.TFile) {
        const metadata = (_a = this.app.metadataCache.getFileCache(noteFile)) == null ? void 0 : _a.frontmatter;
        if (metadata) {
  ...
  renderFileNameFilter() {
    ...
    (0, import_obsidian22.setIcon)(searchButton, "arrow-right");
    ...
    (0, import_obsidian22.setIcon)(clearButton, "x");
    const updateClearButton = () => {
  ...
  async grid_render() {
    ...
    if (this.sourceMode === "bookmarks" && !((_b = (_a = this.app.internalPlugins) == null ? void 0 : _a.plugins.bookmarks) == null ? void 0 : _b.enabled)) {
      new import_obsidian22.Notice(t("bookmarks_plugin_disabled"));
      return;
    }
    ...
    if (this.sourceMode === "folder" && this.sourcePath !== "/" && this.searchQuery === "") {
      if (this.plugin.settings.folderNoteDisplaySettings === "hidden") {
        ...
        if (currentFolder instanceof import_obsidian22.TFolder) {
        ...
        if (entry.isIntersecting) {
          ...
          if (!contentArea.hasAttribute("data-loaded")) {
            if (file.extension === "md") {
              ...
              const frontMatterInfo = (0, import_obsidian22.getFrontMatterInfo)(content);
              let metadata = void 0;
              ...
              if (titleEl) {
                (0, import_obsidian22.setTooltip)(contentArea, `${titleEl.textContent}`);
              }
              if (frontMatterInfo.exists) {
                ...
                if (redirectType && typeof redirectPath === "string" && redirectPath.trim() !== "") {
                  ...
                  if (iconContainer) {
                    (0, import_obsidian22.setIcon)(iconContainer, "shuffle");
                  }
                }
              }
              ...
              (0, import_obsidian22.setTooltip)(fileEl, `${file.name}`, { delay: 2e3 });
            }
            ...
            if (imageArea && !imageArea.hasAttribute("data-loaded")) {
              if (isImageFile(file)) {
                ...
                if (this.plugin.settings.showVideoThumbnails) {
                  ...
                  (0, import_obsidian22.setIcon)(videoThumb, "play-circle");
                }
                imageArea.setAttribute("data-loaded", "true");
    ...
    if (files.length > 0) {
      ...
      const loadMore = (entries) => {
        ...
        const TIME_BUDGET_MS = import_obsidian22.Platform.isIosApp ? 6 : 16;
        const renderChunk = () => {
          if (currentToken !== this.renderToken)
            return;
  ...
  processFile(file, params) {
    ...
    if (!state.pinDividerAdded && this.pinnedList.includes(file.name)) {
      ...
      if (import_obsidian22.Platform.isIosApp) {
    ...
    if (import_obsidian22.Platform.isDesktop && file.extension === "md" && !this.plugin.settings.showNoteInGrid) {
  ...
  addFilesToStash(files) {
    ...
    if (explorerLeaves.length === 0) {
      new import_obsidian22.Notice("\u627E\u4E0D\u5230 explorer \u8996\u5716");
      return;
    }
    const explorerView = explorerLeaves[0].view;
    if (!explorerView) {
      new import_obsidian22.Notice("\u7121\u6CD5\u8A2A\u554F explorer \u8996\u5716");
      return;
    }
    const filePaths = files.map((file) => file.path);
    explorerView.addToStash(filePaths);
    explorerView.refresh();
    new import_obsidian22.Notice(t("added_to_stash"));
  }
    ...
    if (redirectType && typeof redirectPath === "string" && redirectPath.trim() !== "") {
      ...
      if (redirectType === "file") {
        ...
        if (wikilink.startsWith("[[") && wikilink.endsWith("]]")) {
          ...
          target = this.app.vault.getAbstractFileByPath((0, import_obsidian22.normalizePath)(redirectPath));
        }
        if (!target)
          return false;
        if (target instanceof import_obsidian22.TFile) {
          ...
          new import_obsidian22.Notice(`${t("target_not_found")}: ${redirectPath}`);
        }
      } else if (redirectType === "folder") {
        target = this.app.vault.getAbstractFileByPath((0, import_obsidian22.normalizePath)(redirectPath));
        if (!target)
          return false;
        if (target instanceof import_obsidian22.TFolder) {
  ...
  async showNoteInGrid(file) {
            ...
            if (wikilinkRegex.test(valStr)) {
              ...
              if ((key.toLowerCase() === "tags" || key.toLowerCase() === "tag") && !valStr.startsWith("#")) {
                ...
                tagEl.addEventListener("click", (e) => {
                  var _a, _b, _c, _d, _e;
                  e.preventDefault();
                  (_e = (_d = (_c = (_b = (_a = this.app.internalPlugins) == null ? void 0 : _a.getPluginById) == null ? void 0 : _b.call(_a, "global-search")) == null ? void 0 : _c.instance) == null ? void 0 : _d.openGlobalSearch) == null ? void 0 : _e.call(_d, "tag:#" + valStr);
                });
              } else {
                ...
                while ((match = tagRegex.exec(valStr)) !== null) {
                  ...
                  tagEl.addEventListener("click", (e) => {
                    var _a, _b, _c, _d, _e;
                    e.preventDefault();
                    (_e = (_d = (_c = (_b = (_a = this.app.internalPlugins) == null ? void 0 : _a.getPluginById) == null ? void 0 : _b.call(_a, "global-search")) == null ? void 0 : _c.instance) == null ? void 0 : _d.openGlobalSearch) == null ? void 0 : _e.call(_d, "tag:#" + tagName);
                  });
    ...
    if (import_obsidian22.Platform.isMobile && this.noteViewContainer) {
      let startY = 0;
      let startX = 0;
      let currentY = 0;
      let isPulling = false;
...
var IgnoredFolderSuggest = class extends import_obsidian23.AbstractInputSuggest {
...
var GridExplorerSettingTab = class extends import_obsidian23.PluginSettingTab {
  ...
  display() {
    ...
    this.plugin.settings.customModes.forEach((mode, index) => {
      const setting = new import_obsidian23.Setting(customModesContainer).setName(`${mode.icon} ${mode.displayName}`).addToggle((toggle) => {
        var _a;
      ...
      setting.addButton((button) => {
        button.setIcon("pencil").setClass("ge-edit-button").setTooltip(t("edit")).onClick(() => {
      ...
      setting.addButton((button) => {
        button.setIcon("trash-2").setClass("ge-remove-button").setTooltip(t("remove")).setWarning().onClick(() => {
          const modeIndex = this.plugin.settings.customModes.findIndex((m) => m.internalName === mode.internalName);
          if (modeIndex === -1)
            return;
    ...
    new import_obsidian23.Setting(sectionEl).addButton((button) => {
      ...
      button.setButtonText(t("export")).setTooltip(t("export")).onClick(async () => {
        if (this.plugin.settings.customModes.length === 0) {
          new import_obsidian23.Notice(t("no_custom_modes_to_export"));
          return;
        }
        ...
        if (!import_obsidian23.Platform.isDesktop) {
          try {
            ...
            new import_obsidian23.Notice(t("export_success_vault").replace("{filename}", filePath));
          } catch (error) {
            console.error("GridExplorer: Failed to export using Obsidian API on mobile", error);
            new import_obsidian23.Notice(t("export_error"));
          }
        } else {
      ...
      button.setButtonText(t("import")).setTooltip(t("import")).onClick(() => {
        const input2 = activeDocument.createElement("input");
        input2.type = "file";
        input2.accept = ".json";
        input2.onchange = async (e) => {
          ...
          reader.onload = async (e2) => {
            if (!e2.target || typeof e2.target.result !== "string") {
              new import_obsidian23.Notice(t("import_error"));
              return;
            }
            try {
              ...
              if (Array.isArray(importedModes)) {
                ...
                if (validModes.length > 0) {
                  ...
                  await this.plugin.saveSettings();
                  this.display();
                  new import_obsidian23.Notice(t("import_success"));
                } else {
                  new import_obsidian23.Notice(t("import_error"));
                }
              } else {
    ...
    new import_obsidian23.Setting(sectionEl).setName(`\u{1F4D1} ${t("show_bookmarks_mode")}`).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showBookmarksMode).onChange(async (value) => {
        this.plugin.settings.showBookmarksMode = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian23.Setting(sectionEl).setName(`\u{1F50D} ${t("show_search_mode")}`).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showSearchMode).onChange(async (value) => {
        this.plugin.settings.showSearchMode = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian23.Setting(sectionEl).setName(`\u{1F517} ${t("show_backlinks_mode")}`).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showBacklinksMode).onChange(async (value) => {
        this.plugin.settings.showBacklinksMode = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian23.Setting(sectionEl).setName(`\u{1F517} ${t("show_outgoinglinks_mode")}`).addToggle((toggle) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(`\u{1F4D4} ${t("show_all_files_mode")}`).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showAllFilesMode).onChange(async (value) => {
        this.plugin.settings.showAllFilesMode = value;
        await this.plugin.saveSettings();
      });
    });
    const recentFilesSetting = new import_obsidian23.Setting(sectionEl).setName(`\u{1F4C5} ${t("show_recent_files_mode")}`);
    ...
    const randomNoteSetting = new import_obsidian23.Setting(sectionEl).setName(`\u{1F3B2} ${t("show_random_note_mode")}`);
    ...
    new import_obsidian23.Setting(sectionEl).setName(`\u2611\uFE0F ${t("show_tasks_mode")}`).addToggle((toggle) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("reuse_existing_leaf")).setDesc(t("reuse_existing_leaf_desc")).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.reuseExistingLeaf).onChange(async (value) => {
        this.plugin.settings.reuseExistingLeaf = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian23.Setting(sectionEl).setName(t("default_open_location")).setDesc(t("default_open_location_desc")).addDropdown((dropdown) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("default_sort_type")).setDesc(t("default_sort_type_desc")).addDropdown((dropdown) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("date_divider_mode")).setDesc(t("date_divider_mode_desc")).addDropdown((dropdown) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("show_file_name_filter")).setDesc(t("show_file_name_filter_desc")).addToggle((toggle) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("folder_display_style")).setDesc(t("folder_display_style_desc")).addDropdown((dropdown) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("show_media_files")).setDesc(t("show_media_files_desc")).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showMediaFiles).onChange(async (value) => {
        this.plugin.settings.showMediaFiles = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian23.Setting(sectionEl).setName(t("show_video_thumbnails")).setDesc(t("show_video_thumbnails_desc")).addToggle((toggle) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("show_note_in_grid")).setDesc(t("show_note_in_grid_desc")).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showNoteInGrid).onChange(async (value) => {
        this.plugin.settings.showNoteInGrid = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian23.Setting(sectionEl).setName(t("close_grid_view_on_open_note")).setDesc(t("close_grid_view_on_open_note_desc")).addToggle((toggle) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("open_note_layout")).setDesc(t("open_note_layout_desc")).addDropdown((dropdown) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("note_title_field")).setDesc(t("note_title_field_desc")).addText((text) => text.setPlaceholder("title").setValue(this.plugin.settings.noteTitleField).onChange(async (value) => {
      this.plugin.settings.noteTitleField = value;
      await this.plugin.saveSettings(false);
    }));
    new import_obsidian23.Setting(sectionEl).setName(t("note_summary_field")).setDesc(t("note_summary_field_desc")).addText((text) => text.setPlaceholder("summary").setValue(this.plugin.settings.noteSummaryField).onChange(async (value) => {
      this.plugin.settings.noteSummaryField = value;
      await this.plugin.saveSettings(false);
    }));
    new import_obsidian23.Setting(sectionEl).setName(t("modified_date_field")).setDesc(t("modified_date_field_desc")).addText((text) => text.setPlaceholder("modified_date").setValue(this.plugin.settings.modifiedDateField).onChange(async (value) => {
      this.plugin.settings.modifiedDateField = value;
      await this.plugin.saveSettings(false);
    }));
    new import_obsidian23.Setting(sectionEl).setName(t("created_date_field")).setDesc(t("created_date_field_desc")).addText((text) => text.setPlaceholder("created_date").setValue(this.plugin.settings.createdDateField).onChange(async (value) => {
      this.plugin.settings.createdDateField = value;
      await this.plugin.saveSettings(false);
    }));
    new import_obsidian23.Setting(sectionEl).setName(t("custom_document_extensions")).setDesc(t("custom_document_extensions_desc")).addText((text) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("custom_folder_icon")).setDesc(t("custom_folder_icon_desc")).addText((text) => {
      text.setValue(this.plugin.settings.customFolderIcon).onChange(async (value) => {
        this.plugin.settings.customFolderIcon = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian23.Setting(sectionEl).setName(t("enable_file_watcher")).setDesc(t("enable_file_watcher_desc")).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.enableFileWatcher).onChange(async (value) => {
        this.plugin.settings.enableFileWatcher = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian23.Setting(sectionEl).setName(t("intercept_all_tag_clicks")).setDesc(t("intercept_all_tag_clicks_desc")).addToggle((toggle) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("intercept_breadcrumb_clicks")).setDesc(t("intercept_breadcrumb_clicks_desc")).addToggle((toggle) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("card_layout")).setDesc(t("card_layout_desc")).addDropdown((drop) => {
      drop.addOption("horizontal", t("horizontal_card"));
      drop.addOption("vertical", t("vertical_card"));
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("show_note_tags")).setDesc(t("show_note_tags_desc")).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.showNoteTags).onChange(async (value) => {
        this.plugin.settings.showNoteTags = value;
        await this.plugin.saveSettings();
      });
    });
    const gridItemWidthSetting = new import_obsidian23.Setting(sectionEl).setName(`${t("horizontal_card")} ${t("grid_item_width")}`).setDesc(`${t("grid_item_width_desc")} (now: ${this.plugin.settings.gridItemWidth}px)`).addSlider((slider) => {
    ...
    const gridItemHeightSetting = new import_obsidian23.Setting(sectionEl).setName(`${t("horizontal_card")} ${t("grid_item_height")}`).setDesc(`${t("grid_item_height_desc")} (now: ${this.plugin.settings.gridItemHeight === 0 ? "auto" : this.plugin.settings.gridItemHeight})`).addSlider((slider) => {
    ...
    const imageAreaWidthSetting = new import_obsidian23.Setting(sectionEl).setName(`${t("horizontal_card")} ${t("image_area_width")}`).setDesc(`${t("image_area_width_desc")} (now: ${this.plugin.settings.imageAreaWidth}px)`).addSlider((slider) => {
    ...
    const imageAreaHeightSetting = new import_obsidian23.Setting(sectionEl).setName(`${t("horizontal_card")} ${t("image_area_height")}`).setDesc(`${t("image_area_height_desc")} (now: ${this.plugin.settings.imageAreaHeight}px)`).addSlider((slider) => {
    ...
    const vGridItemWidthSetting = new import_obsidian23.Setting(sectionEl).setName(`${t("vertical_card")} ${t("grid_item_width")}`).setDesc(`${t("grid_item_width_desc")} (now: ${this.plugin.settings.verticalGridItemWidth}px)`).addSlider((slider) => {
    ...
    const vGridItemHeightSetting = new import_obsidian23.Setting(sectionEl).setName(`${t("vertical_card")} ${t("grid_item_height")}`).setDesc(`${t("grid_item_height_desc")} (now: ${this.plugin.settings.verticalGridItemHeight}px)`).addSlider((slider) => {
    ...
    const vImageAreaHeightSetting = new import_obsidian23.Setting(sectionEl).setName(`${t("vertical_card")} ${t("image_area_height")}`).setDesc(`${t("image_area_height_desc")} (now: ${this.plugin.settings.verticalImageAreaHeight}px)`).addSlider((slider) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(`${t("vertical_card")} ${t("image_position")}`).setDesc(t("image_position_desc")).addDropdown((dropdown) => {
    ...
    const titleFontSizeSetting = new import_obsidian23.Setting(sectionEl).setName(t("title_font_size")).setDesc(`${t("title_font_size_desc")} (now: ${this.plugin.settings.titleFontSize.toFixed(2)})`).addSlider((slider) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("multi_line_title")).setDesc(t("multi_line_title_desc")).addToggle((toggle) => {
      toggle.setValue(this.plugin.settings.multiLineTitle).onChange(async (value) => {
        this.plugin.settings.multiLineTitle = value;
        await this.plugin.saveSettings();
      });
    });
    const summaryLengthSetting = new import_obsidian23.Setting(sectionEl).setName(t("summary_length")).setDesc(`${t("summary_length_desc")} (now: ${this.plugin.settings.summaryLength})`).addSlider((slider) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("show_code_block_in_summary")).setDesc(t("show_code_block_in_summary_desc")).addToggle((toggle) => toggle.setValue(this.plugin.settings.showCodeBlocksInSummary).onChange(async (value) => {
      this.plugin.settings.showCodeBlocksInSummary = value;
      await this.plugin.saveSettings();
    }));
    sectionEl = this.createSection(t("default_search_option"));
    new import_obsidian23.Setting(sectionEl).setName(t("search_current_location_only")).addToggle((toggle) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("search_files_name_only")).addToggle((toggle) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("search_media_files")).addToggle((toggle) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("foldernote_display_settings")).setDesc(t("foldernote_display_settings_desc")).addDropdown((dropdown) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("quick_access_folder_name")).setDesc(t("quick_access_folder_desc")).addText((text) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("quick_access_mode_name")).setDesc(t("quick_access_mode_desc")).addDropdown((dropdown) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("use_quick_access_as_new_tab_view")).setDesc(t("use_quick_access_as_new_tab_view_desc")).addDropdown((dropdown) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("ignored_folders")).setDesc(t("ignored_folders_desc")).setHeading();
    new import_obsidian23.Setting(ignoredFoldersContainer).setName(t("add_ignored_folder")).addText((text) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("ignored_folder_patterns")).setDesc(t("ignored_folder_patterns_desc")).setHeading();
    const patternSetting = new import_obsidian23.Setting(ignoredFolderPatternsContainer).setName(t("add_ignored_folder_pattern")).addText((text) => {
    ...
    new import_obsidian23.Setting(sectionEl).setName(t("config_management")).setDesc(t("config_management_desc")).addButton((button) => button.setButtonText(t("reset_to_default")).setWarning().onClick(async () => {
      this.plugin.settings = { ...DEFAULT_SETTINGS };
      await this.plugin.saveSettings();
      this.display();
      new import_obsidian23.Notice(t("settings_reset_notice"));
      ...
      input2.onchange = async (e) => {
        ...
        reader.onload = async (evt) => {
          if (!evt.target || typeof evt.target.result !== "string") {
            new import_obsidian23.Notice(t("import_failed"));
            return;
          }
          try {
...
// src/main.ts
var GridExplorerPlugin = class extends import_obsidian24.Plugin {
  constructor() {
    super(...arguments);
  ...
  async onload() {
    ...
    this.addCommand({
      ...
      callback: async () => {
        ...
        if (targetFile instanceof import_obsidian24.TFolder) {
      ...
      this.app.workspace.on("file-menu", (menu, file) => {
        ...
        if (file instanceof import_obsidian24.TFile) {
          menu.addItem((item) => {
            ...
            if (this.settings.showRecentFilesMode && file instanceof import_obsidian24.TFile) {
              ogSubmenu.addItem((item2) => {
    ...
    this.registerEvent(
      onWorkspaceEvent("tag-wrangler:contextmenu", (...data) => {
        ...
        if (!(menu instanceof import_obsidian24.Menu) || typeof tagName !== "string") {
          return;
        }
      ...
      this.app.workspace.getLeavesOfType("canvas").forEach((leaf) => {
        ...
        const dropHandler = async (evt) => {
          ...
          for (let i = 0; i < filePaths.length; i++) {
            ...
            if (!(tfile instanceof import_obsidian24.TFile)) {
  ...
  async openNoteInRecentFiles(file) {
    const view = await this.activateView();
    if (view instanceof GridView) {
      view.targetFocusPath = file instanceof import_obsidian24.TFile ? file.path : null;
      await view.setSource("recent-files");
    }
  }
  // 打開筆記到資料夾模式
  async openNoteInFolder(file = this.app.vault.getRoot()) {
    var _a;
    const folderPath = file ? file instanceof import_obsidian24.TFile ? (_a = file.parent) == null ? void 0 : _a.path : file.path : "/";
    const view = await this.activateView();
    if (view instanceof GridView) {
      view.targetFocusPath = file instanceof import_obsidian24.TFile ? file.path : null;
      await view.setSource("folder", folderPath);
