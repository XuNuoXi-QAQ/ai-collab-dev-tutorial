...
| MOC | 篇数 | 跳转 |
|-----|------|------|
| 🧠 AI 工具链 | `= length(filter([[AI 工具链 MOC]].file.outlinks, (l) => !contains(l.tags, "MOC")))` | [[AI 工具链 MOC]] |
| 🖥️ 系统运维 | `= length(filter([[系统运维 MOC]].file.outlinks, (l) => !contains(l.tags, "MOC")))` | [[系统运维 MOC]] |
| 🔧 硬件与DIY | `= length(filter([[硬件与DIY MOC]].file.outlinks, (l) => !contains(l.tags, "MOC")))` | [[硬件与DIY MOC]] |
